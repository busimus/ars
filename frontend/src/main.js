...
Sentry.init({
  ...
  ignoreErrors: [/WebSocket connection failed/i, /RPC Request failed/i, /Already processing eth_requestAccounts/i, /Requested resource not available/i, /Socket stalled when trying to connect/i, /The operation was aborted/i],
